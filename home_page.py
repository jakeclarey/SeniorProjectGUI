...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Scan Keycard button
        keycard_button = tk.Button(self, text="Scan Keycard", font=("Arial", 14),
                           width=14, height=2,
                           command=self.start_keycard_scan)
        keycard_button.place(x=10, y=10)  # Top-left position
        
        # Admin button
        admin_button = tk.Button(self, text="Admin", font=("Arial", 14),
                           width=8, height=2,
        ...
        stock_button = tk.Button(self, text="View Available Stock", font=("Arial", 14),
                           width=18, height=2,
        ...
        self.status_label = tk.Label(self, text="", font=("Arial", 16), bg="#0032A0", fg="white")
        self.status_label.place(relx=0.5, rely=0.9, anchor="center")
        
        # White box with thick black border
        box_frame = tk.Frame(self, bg="white", highlightbackground="black", highlightthickness=25)
        ...
        try:
            ...
            tk.Label(box_frame, text="Image Not Found", font=("Arial", 18), bg="white").place(relx=0.5, rely=0.3, anchor="center")
        
        # Text below the image inside the box
        project_text = tk.Label(box_frame, text="Hardware Sorting and Dispense", font=("Arial", 18), bg="white")
    ...
    def run_scan(self):
        ...
        if result:
            ...
            self.controller.current_user_credits = keycard.get_user_credits(self.controller.current_user_id)
            ...
            print(f"                 Credits = {self.controller.current_user_credits}")
            self.after(0, lambda: self.status_label.config(text="Keycard Timeout - Please Try Again"))
