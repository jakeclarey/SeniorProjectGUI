...
class ActivityPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        return_btn = tk.Button(self, text="Return to Home", **btn_style,
                               command=lambda: controller.show_frame("HomePage"))
        return_btn.place(x=10, y=10)

        dispense_btn = tk.Button(self, text="Dispense Hardware", **btn_style,
                                 command=lambda: controller.show_frame("DispenseSelectPage"))
        dispense_btn.place(x=230, y=10)

        sort_btn = tk.Button(self, text="Sort Hardware", **btn_style,
        ...
        project_text = tk.Label(box_frame, text="Select an Activity", font=("Arial", 18), bg="white")
