...
class AdminPwdPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Title
        title_label = tk.Label(self, text="Admin Login", font=("Arial", 28), fg="white", bg="#0032A0")
        title_label.place(relx=0.5, y=50, anchor="center")

        # Instruction label
        password_label = tk.Label(self, text="Enter Admin Password:", font=("Arial", 18), fg="white", bg="#0032A0")
        password_label.place(relx=0.5, rely=0.2, anchor="center")

        # Password display (masked)
        self.password_display = tk.Label(self, text="", font=("Arial", 32), fg="white", bg="#0032A0")
        ...
        for (text, row, col) in buttons:
            ...
            btn = tk.Button(keypad_frame, text=text, font=("Arial", 18), width=6, height=2, command=cmd)
            btn.grid(row=row, column=col, padx=10, pady=10)

        # Back button
        back_button = tk.Button(self, text="Back", font=("Arial", 14), width=8, height=2,
